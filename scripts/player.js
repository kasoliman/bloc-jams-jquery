class Player {
  ...
  prettyTime(timeInSeconds){
    //timeInSeconds = this.soundObject.getTime();
    const durationInMinutes = Math.floor(timeInSeconds / 60);
    const durationInSeconds = Math.floor(timeInSeconds - (durationInMinutes*60));
